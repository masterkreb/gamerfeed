    ...
    en: {
        translation: {
            ...
            "admin": {
                ...
                "warningFeedsDesc": "The following feeds were fetched successfully by the backend, but they have no articles in the active news snapshot. That can mean the feed is empty, outdated, or its articles were filtered out before publishing.",
    ...
    de: {
        translation: {
            ...
            "admin": {
                ...
                "warningFeedsDesc": "Die folgenden Feeds wurden vom Backend erfolgreich abgerufen, haben aber keine Artikel im aktiven News-Snapshot. Das kann bedeuten, dass der Feed leer oder veraltet ist oder seine Artikel vor der Veröffentlichung herausgefiltert wurden.",
